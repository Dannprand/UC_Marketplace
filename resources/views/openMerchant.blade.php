...
<head>
    ...
    <style>
        * {
        ...
        .success-message {
            display: none; /* Defaultnya sembunyikan */
            position: fixed;
            top: 20px;
            right: 20px;
            background: #48bb78;
            ...
            z-index: 100;
            animation: slideIn 0.5s ease forwards; /* Tambah forwards agar tetap di akhir animasi */
        }

        /* Styling untuk pesan error dari Laravel */
        .error-message {
            background: #e53e3e; /* Merah untuk error */
            color: white;
            padding: 15px 25px;
            border-radius: 10px;
            box-shadow: 0 5px 15px rgba(0,0,0,0.15);
            ...
            text-align: left;
            position: relative; /* Agar bisa muncul di atas form */
            z-index: 99;
        }
...
<body>
    <div class="container animate__animated animate__fadeInUp">
        <div class="illustration">
            <div style="width: 100%; max-width: 300px;">
                <svg viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg">
                    <path fill="#ffffff" d="M75,150 C75,99.08 116.08,58 167,58 C217.92,58 259,99.08 259,150 C259,200.92 217.92,242 167,242 C116.08,242 75,200.92 75,150 Z" opacity="0.1"/>
                    <path fill="#ffffff" d="M167,75 C123.86,75 89,109.86 89,153 C89,196.14 123.86,231 167,231 C210.14,231 245,196.14 245,153 C245,109.86 210.14,75 167,75 Z" opacity="0.3"/>
                    <circle fill="#ffffff" cx="167" cy="153" r="70" opacity="0.5"/>
                    <rect fill="#ffffff" x="147" y="133" width="40" height="40" rx="8" opacity="0.8"/>
                    <path fill="#ffffff" d="M167,110 C167,104.48 171.48,100 177,100 C182.52,100 187,104.48 187,110 C187,115.52 182.52,120 177,120 C171.48,120 167,115.52 167,110 Z" opacity="0.8"/>
                    <path fill="#ffffff" d="M300,100 L300,220 C300,227.18 294.18,233 287,233 L247,233 C239.82,233 234,227.18 234,220 L234,100 C234,92.82 239.82,87 247,87 L287,87 C294.18,87 300,92.82 300,100 Z" opacity="0.3"/>
        ...
        <div class="merchant-form">
            ...
            <form method="POST" action="{{ route('merchant.open') }}" enctype="multipart/form-data" class="form-container">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="merchant_password" name="merchant_password" class="form-input"
    ...
    {{-- Pesan sukses ini akan dikelola oleh Laravel, bukan JS --}}
    @if(session('success'))
        <div class="success-message animate__animated animate__fadeIn" id="successMessage">
        ...
        <script>
            ...
            setTimeout(() => {
                ...
                if (successMsg) {
                    successMsg.classList.remove('animate__fadeIn');
    ...
    <script>
        ...
        // --- Bagian JavaScript ini dihapus karena penanganan submit akan langsung ke Laravel ---
        ...
        //     }, 1500);
        // });
        // --- Akhir Bagian JavaScript yang dihapus ---
    </script>
</body>
</html>